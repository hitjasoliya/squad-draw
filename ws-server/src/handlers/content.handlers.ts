...
export const newShapeHandler = async (
  ...
  const createdShape = await queryOne<{
    ...
    `INSERT INTO shapes (type, data_from_rough_js, room_id, creator_id, created_at, updated_at)
...
export const newMessageHandler = async (
  ...
  try {
    ...
    await query(
      `INSERT INTO messages (message, room_id, user_id, created_at)
       VALUES ($1, $2, $3, NOW())`,
