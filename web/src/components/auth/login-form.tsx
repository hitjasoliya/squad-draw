...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="relative border-border/80 shadow-xl bg-card/90 glass-panel">
        ...
        <CardHeader className="text-center pt-8 pb-2">
          ...
          <CardDescription className="text-muted-foreground text-sm">
            {isSignUp
              ...
              : "Sign in to access your whiteboard rooms"}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form
          ...
          >
            <div className="grid gap-6">
              ...
              <div className="grid gap-6">
                ...
                <Button type="submit" className="w-full h-10 font-medium shadow-md shadow-primary/20" disabled={isLoading}>
                  {isLoading ? (
